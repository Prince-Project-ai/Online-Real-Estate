...
import { addSellerProperty } from "../Controllers/Seller.controller.js";
...
router.post("/add-seller-property", verifyJWT, upload.array('propertyImages', 10), addSellerProperty);
