  ...
  return (
    <div className="bg-white animate-tada rounded-lg shadow-lg max-w-md w-full relative">
      ...
      <div className="p-4 border-t border-gray-200 text-center">
        <button
          type="submit"
          className="font-inter w-full py-2 px-4 tracking-wide animate-tada bg-dark text-white rounded-md focus:outline-none focus:ring hover:ring-2 focus:ring-offset-2 hover:ring-offset-2 disabled:cursor-not-allowed hover:ring-black focus:ring-black"
        >
          Edit Now
        </button>
      </div>
