...
const DashContent = ({ setTotalUser }) => {
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-4">
        ...
        <div className="relative">
          <input
            ...
            className="border rounded-lg pl-9 pr-4 py-2 focus:outline-none focus:ring-1 focus:ring-dark w-full"
          />
